        ...
        <table style="border-collapse: collapse;font-size:12px">
            ...
            <tbody style="font-size:12px">
                ...
                <tr>
                    ...
                    <td class="border text-center">
                        {{ $tandaVital->riwayat_penyakit_sekarang_text  }}
                    </td>
                ...
                <tr>
                    ...
                    <td class="border text-center">
                        {{ $tandaVital->riwayat_penyakit_terdahulu_text }}
                    </td>
                ...
                <tr>
                    ...
                    <td class="border text-center">
                        {{ $tandaVital->komsumsi_alkohol ? 'YA' : 'TIDAK' }}
                    </td>
                ...
                <tr>
                    ...
                    <td class="border text-center">
                        {{ $tandaVital->riwayat_trauma_text }}
                    </td>
                ...
                <tr>
                    ...
                    <td class="border text-center">
                        {{ $tandaVital->frekuensi_nadi }} x/menit
                    </td>
                ...
                <tr>
                    ...
                    <td class="border text-center">
                        {{ $pemeriksaanFisik->visus }}
                    </td>
                </tr>
                <tr>
                    <td class="border">Buta Warna</td>
                    <td class="border text-center">
                        {{ $pemeriksaanFisik->buta_warna }}
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="border text-center">
                        {{ $pemeriksaanFisik->kelainan_telinga }}
                    </td>
                </tr>
                <tr>
                    <td class="border">Gigi</td>
                    <td class="border text-center">
                        {{ $pemeriksaanFisik->gigi }}
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="border text-center">
                        {{ $pemeriksaanFisik->bibir }}
                    </td>
                </tr>
                <tr>
                    <td class="border">Lidah</td>
                    <td class="border text-center">
                        {{ $pemeriksaanFisik->lidah }}
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="border text-center">
                        {{ $pemeriksaanFisik->tenggorokan_text }}
                    </td>
                </tr>
                <tr>
                    <td class="border">Faring</td>
                    <td class="border text-center">
                        {{ $pemeriksaanFisik->faring }}
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="border text-center">
                        {{ $pemeriksaanFisik->leher_kgb }}
                    </td>
                </tr>
                <tr>
                    <td class="border">Leher JVP</td>
                    <td class="border text-center">
                        {{ $pemeriksaanFisik->leher_jvp }}
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="border text-center">
                        {{ $pemeriksaanFisik->jantung_inspeksi }}
                    </td>
                </tr>
                <tr>
                    <td class="border">Auskultasi</td>
                    <td class="border text-center">
                        {{ $pemeriksaanFisik->jantung_auskultasi }}
                    </td>
                </tr>
                <tr>
                    <td class="border">Palpasi</td>
                    <td class="border text-center">
                        {{ $pemeriksaanFisik->jantung_palpasi }}
                    </td>
                </tr>
                <tr>
                    <td class="border">Perkusi</td>
                    <td class="border text-center">
                        {{ $pemeriksaanFisik->jantung_perkusi }}
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="border">Inspeksi</td>
                    <td class="border text-center">
                        {{ $pemeriksaanFisik->paru_inspeksi }}
                    </td>
                </tr>
                <tr>
                    <td class="border">Auskultasi Vasikuler</td>
                    <td class="border text-center">
                        {{ $pemeriksaanFisik->paru_auskultasi_vasikuler }}
                    </td>
                </tr>
                <tr>
                    <td class="border">Auskultasi Ronkhi</td>
                    <td class="border text-center">
                        {{ $pemeriksaanFisik->paru_auskultasi_ronkhi }}
                    </td>
                </tr>
                <tr>
                    <td class="border">Auskultasi Wheezing</td>
                    <td class="border text-center">
                        {{ $pemeriksaanFisik->paru_auskultasi_wheezing }}
                    </td>
                </tr>
                <tr>
                    <td class="border">Palpasi</td>
                    <td class="border text-center">
                        {{ $pemeriksaanFisik->paru_palpasi }}
                    </td>
                </tr>
                <tr>
                    <td class="border">Perkusi</td>
                    <td class="border text-center">
                        {{ $pemeriksaanFisik->paru_perkusi }}
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="border text-center">
                        {{ $pemeriksaanFisik->reflex_fisiologis_atas }}
                    </td>
                </tr>
                <tr>
                    <td class="border">Reflex Phatologis Atas</td>
                    <td class="border text-center">
                        {{ $pemeriksaanFisik->reflex_phatologis_atas }}
                    </td>
                </tr>
                <tr>
                    <td class="border">Reflex Fisiologis Bawah</td>
                    <td class="border text-center">
                        {{ $pemeriksaanFisik->reflex_fisiologis_bawah }}
                    </td>
                </tr>
                <tr>
                    <td class="border">Reflex Phatologis Bawah</td>
                    <td class="border text-center">
                        {{ $pemeriksaanFisik->reflex_phatologis_bawah }}
                    </td>
                </tr>
                @if ($pemeriksaanFisik->lab_diperiksa)
                    ...
                    <tr>
                        ...
                        <td class="border text-center">
                            {{ $participant->laboratorium?->kesimpulan }}
                        </td>
                    </tr>
                @endif
                <tr>
                ...
                @if($participant->pemeriksaanFisik->audiometri_diperiksa == 1)
                    ...
                    <tr>
                        ...
                        <td class="border text-center">
                            {{ $participant->audiometri_diperiksa == 1 ? "DIPERIKSA" : "TIDAK DIPERIKSA" }}
                        </td>
                    </tr>
                    <tr>
                ...
                @if ($participant->pemeriksaanFisik?->ekg_diperiksa)
                    ...
                    <tr>
                        ...
                        <td class="border text-center">
                            {{ $participant->ekg_diperiksa ? "DIPERIKSA" : "TIDAK DIPERIKSA" }}
                        </td>
                    </tr>
                @endif
                @if ($participant->pemeriksaanFisik?->spiro_diperiksa)
                    ...
                    <tr>
                        ...
                        <td class="border text-center">
                            {{ $participant->spirometri?->selesai ? "DIPERIKSA" : "TIDAK DIPERIKSA" }}
                        </td>
                    </tr>
                @endif
                @if ($participant->pemeriksaanFisik?->rectal_diperiksa)
                    ...
                    <tr>
                        ...
                        <td class="border text-center">
                            {{ $participant->rectal?->salmonella_thypi ? "DIPERIKSA" : "TIDAK DIPERIKSA"  }}
                        </td>
                    </tr>
                    <tr>
                        <td class="border">Shigella SP</td>
                        <td class="border text-center">
                            {{ $participant->rectal?->shigella_sp ? "DIPERIKSA" : "TIDAK DIPERIKSA" }}
                        </td>
                    </tr>
                    <tr>
                        <td class="border">E. Coli Pathogen</td>
                        <td class="border text-center">
                            {{ $participant->rectal?->e_coli_pathogen ? "DIPERIKSA" : "TIDAK DIPERIKSA"  }}
                        </td>
                    </tr>
                @endif
