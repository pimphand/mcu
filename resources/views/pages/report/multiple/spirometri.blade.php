@foreach ($data as $index => $spirometri)
    ...
    <body>
        ...
        @endphp
        <div class="text-center" style="font-size: 18px; width: 100%; margin-bottom: 10px; margin-top: 10px;">SPIROMETRI
        </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="text-center">
                                        <img src="{{ public_path($spirometri->employee?->ttd ? $spirometri->employee?->ttd : 'images/ttd-kosong.png') }}"
        ...
        <div class="footer"
            style="position: fixed; bottom: 0; left: 0; right: 0; width: 100%; text-align: end; font-size: 12px;">
