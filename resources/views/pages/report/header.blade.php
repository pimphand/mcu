                ...
                <table>
                    ...
                    <tr>
                        <td style="text-align: center;">
                            <p style="padding: 0px; margin: 0px; font-size: 20px;font-style: bold">KLINIK DR. DINI <br>
                                MEDICAL CENTER
                            </p>
                            <p style="margin: 0px;font-size: 13px;">No.Izin : 0104220009994 <br>
...
<div style="height: 1px; width: 100%; background-color: rgb(126, 126, 126); margin-bottom: 2px"></div>
